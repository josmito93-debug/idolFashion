      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container max-w-7xl mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          <motion.img 
            ...
            className="h-12 md:h-24 mb-8 md:mb-12 object-contain"
          />
          ...
          >
            <p className="detail-text text-[11px] md:text-base opacity-40 uppercase tracking-[0.3em] text-center leading-relaxed">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-4 md:gap-8 justify-center items-center w-full max-w-[320px] sm:max-w-none px-4"
          >
            <Link 
              href="/register" 
              className="px-10 py-5 bg-white text-black font-modal text-xs tracking-[0.3em] uppercase hover:border-accent/30 transition-all duration-300 detail-text relative overflow-hidden group shadow-sm flex items-center justify-center sm:min-w-[280px]"
            >
            ...
            <Link 
              ...
              className="px-10 py-5 bg-white/5 backdrop-blur-md border border-white/20 text-white font-modal text-xs tracking-[0.3em] uppercase hover:bg-white/10 transition-all group flex items-center gap-3 sm:min-w-[280px] justify-center"
            >
